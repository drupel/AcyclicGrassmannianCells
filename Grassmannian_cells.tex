...
\begin{proof}
  ...
  If $Q'$ is wild or of extended Dynkin type, let $M$ be any indecomposable representation of $Q'$ such that $\beta=\udim M$ is an imaginary root of $Q'$, and hence an imaginary root of $Q$.
  \sayD{We should probably be a little more careful here to guarantee that vertex $i$ lies in the support of $M$.}
