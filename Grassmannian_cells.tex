...
\begin{proposition}
  ...
  \begin{enumerate}
    \item If $m_r\ge0$, there exists a filtration
      \[P_{i_r,m_r} \subset P_{i_{r+1},m_{r+1}} \subset \cdots \subset P_{i_k,m_k} \subset P_{i'_{k'},{m'}^*_{\! k'}}\]
      and, if $m'_{r'}\ge0$, there exists a filtration
      \[P_{i'_{r'},m'_{r'}} \subset P_{i'_{r'+1},m'_{r'+1}} \subset \cdots \subset P_{i'_{k'},m'_{k'}} \subset P_{i_k,m^*_k}.\]
    \item 
