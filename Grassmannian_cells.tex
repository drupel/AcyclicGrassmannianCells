...
\section{Truncated preprojective representations of tree quivers}
  ...
  \begin{lemma}
    \sayT{maybe statement is not quite correct}
    ...
    Then $P_{i_k,m_k}/P_{i_0,m_0}$ is preinjective if and only if $i_1$ is a limb \sayD{with respect to\dots}, or if $|N_{i_1}|=3$, $i_2$ and the other neighbor $q_1\neq i_0$ of $i_1$ are limbs and $i_k$ a leaf. 
\end{lemma}
\begin{proof}
